...
- Kampagnenbasiertes State-Modell in `../../07_runtime/campaigns/*.json`
...
## Daten & Repo-Hygiene
- Laufende Kampagnen liegen lokal in `../../07_runtime/campaigns/`.
- Automations-/Longrun-Artefakte liegen lokal in `../../07_runtime/temp/automation_runs/`.
